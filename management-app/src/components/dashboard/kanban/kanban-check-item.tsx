...
import { deleteCheckItem, updateCheckItem } from '../../../slices';
...
const KanbanCheckItem: FC<KanbanCheckItemProps> = (props) => {
  ...
  const handleStateChange = async (
    ...
    try {
      ...
      await dispatch(
        updateCheckItem(cardId, checklistId, checkItem._id, { state })
      );
  ...
  const handleSave = async (): Promise<void> => {
    try {
      await dispatch(
        updateCheckItem(cardId, checklistId, checkItem._id, { name })
      );
      toast.success('Check item updated!');
  ...
  const handleDelete = async (): Promise<void> => {
    try {
      await dispatch(deleteCheckItem(cardId, checklistId, checkItem._id));
